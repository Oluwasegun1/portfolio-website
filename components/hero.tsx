...
export default function Hero() {
  ...
  return (
    <section id="home" className="flex min-h-[calc(100vh-4rem)] flex-col items-center justify-center py-20 text-center">
      <motion.div className="max-w-3xl" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <motion.p
        ...
        <h1 ref={nameRef} className="mb-6 text-5xl font-bold leading-tight tracking-tighter md:text-7xl">
          Oluwasegun
        </h1>
        ...
        >
          A passionate web developer crafting beautiful, interactive, and responsive websites with modern technologies.
        </motion.p>
        ...
        >
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button size="lg" className="gap-2 relative overflow-hidden group" onClick={scrollToProjects}>
